...
const voiceChannels = message.guild.channels.cache.filter(c => c.type === 'voice');
  ...
  let  çevrimiçi = message.guild.members.cache.filter(m => !m.user.bot && m.user.presence.status !== "offline").size
    const legend  = new Discord.MessageEmbed()
        .setColor("#00a5ff")
        .setThumbnail(`https://cdn.discordapp.com/attachments/801230914515632148/808102120976285705/legendproject.gif`)
        ...
        .setFooter(`Legend Project`, client.user.avatarURL())
